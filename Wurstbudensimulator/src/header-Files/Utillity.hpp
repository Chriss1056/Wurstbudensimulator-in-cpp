...
namespace console
{
	enum foreground
	{
		...
		F_WHITE_H = FOREGROUND_INTENSITY | FOREGROUND_RED | FOREGROUND_GREEN | FOREGROUND_BLUE,
	};
	enum background
	{
		B_BLACK = 0,
		...
		B_WHITE_H = BACKGROUND_INTENSITY | BACKGROUND_RED | BACKGROUND_GREEN | BACKGROUND_BLUE,
	};
	enum special
	{
